...
-- 3. ตารางสาขา (branches) และตั้งค่าสาขา URT (สุราษฎร์ธานี) เป็นค่าเริ่มต้น
...
INSERT INTO branches (org_id, code, name, color, status)
VALUES ('00000000-0000-0000-0000-000000000001', 'URT', 'สาขาสุราษฎร์ธานี (URT)', 'teal', 'ACTIVE')
ON CONFLICT (org_id, code) DO UPDATE
SET name = 'สาขาสุราษฎร์ธานี (URT)', status = 'ACTIVE';
