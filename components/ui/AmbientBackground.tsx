...
export const AmbientBackground = () => {
  return (
    <div className="fixed inset-0 z-[-1] overflow-hidden pointer-events-none">
      ...
      <div className="absolute inset-0 opacity-[0.15] [background-image:linear-gradient(to_right,var(--border-edge)_1px,transparent_1px),linear-gradient(to_bottom,var(--border-edge)_1px,transparent_1px)] [background-size:32px_32px]" />
      ...
      <div className="absolute right-0 top-0 h-full w-px bg-gradient-to-b from-transparent via-edge to-transparent" />
    </div>
  );
};
